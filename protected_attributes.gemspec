...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "activemodel",  ">= 4.0.1", "< 5.3"

  gem.add_development_dependency "activerecord", ">= 4.0.1", "< 5.3"
  gem.add_development_dependency "actionpack",   ">= 4.0.1", "< 5.3"
  gem.add_development_dependency "railties",   ">= 4.0.1", "< 5.3"
